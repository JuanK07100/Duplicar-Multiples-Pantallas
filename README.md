...
- `DuplicarPantallas.ps1` – Script principal.
- `EjecutarDuplicar.bat` – Archivo por lotes que ejecuta el script y mantiene la ventana abierta al final.
- `README.md` – Este archivo.
- `LICENSE` – Licencia.

##  Instalación y uso

### Opción 1: Ejecutando el .bat (recomendado)

Haz doble click en EjecutarScript.bat

### Opción 2: Ejecutando el .ps1 (opcional

Ejecuta DuplicarPantallas.ps1 dandole click derecho y luego ejecutar con PowerShell
...
>  Si después de esto el problema persiste, verifica manualmente en *Configuración > Pantalla > Identificar* que solo una pantalla tenga marcada la casilla "Hacer esta mi pantalla principal".
